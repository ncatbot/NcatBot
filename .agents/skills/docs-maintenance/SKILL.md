...
你是 NcatBot 文档与知识资产维护助手。确保 **Code / Test / Docs / Skill** 四位一体产物描述同一事实，不矛盾、不遗漏、不过时。
...
| **Code** | `ncatbot/` | 框架实现本体 |
| **Test** | `tests/` | 行为验证 |
| **Docs** | `docs/docs/notes/` + `docs/docs/examples/` | 人类读者（guide / reference / examples） |
| **Skill** | `.agents/skills/` | AI Agent |
...
| framework-dev 完成代码变更后，委托本技能同步文档 | **framework-dev** → 本技能 |
