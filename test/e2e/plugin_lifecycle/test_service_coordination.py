...
class TestRegisterHandlerCoordination:
    ...
    @pytest.mark.asyncio
    async def test_register_handler_coordination_complete(self, test_suite: E2ETestSuite, handler_plugin_name):
...
class TestUnifiedRegistryCoordination:
    ...
    @pytest.mark.asyncio
    async def test_unified_registry_coordination_complete(self, test_suite: E2ETestSuite, command_plugin_name):
...
class TestMultiServiceCoordination:
    ...
    @pytest.mark.asyncio
    async def test_multi_service_coordination_complete(self, test_suite: E2ETestSuite, full_feature_plugin_name):
        """测试多服务协作（综合测试）
