...
class TestBasicPluginUnloading:
    ...
    @pytest.mark.asyncio
    async def test_basic_plugin_unloading_complete(self, test_suite: E2ETestSuite, basic_plugin_name):
        """测试插件基础卸载功能（综合测试）
...
class TestCommandCleanupOnUnload:
    ...
    @pytest.mark.asyncio
    async def test_command_cleanup_complete(self, test_suite: E2ETestSuite, command_plugin_name):
        """测试命令插件卸载后的清理（综合测试）
...
class TestConfigCleanupOnUnload:
    ...
    @pytest.mark.asyncio
    async def test_config_cleanup_complete(self, test_suite: E2ETestSuite, config_plugin_name):
        """测试配置插件卸载后的清理（综合测试）
...
class TestHandlerCleanupOnUnload:
    ...
    @pytest.mark.asyncio
    async def test_handler_cleanup_complete(self, test_suite: E2ETestSuite, handler_plugin_name):
        """测试事件处理器卸载后的清理（综合测试）
...
class TestFullFeaturePluginUnloading:
    ...
    @pytest.mark.asyncio
    async def test_full_feature_unloading_complete(self, test_suite: E2ETestSuite, full_feature_plugin_name):
        """测试完整功能插件卸载（综合测试）
