...
class TestPreUploadServiceE2E:
    ...
    @pytest.mark.asyncio
    async def test_message_processing_complete(
        self, preupload_suite, temp_test_files
    ):
        """消息预处理复合测试
        ...
        message = {
            "type": "image",
            "data": {"file": "https://example.com/img.jpg"}
        }
        result = await preupload.process_message(message)
        assert result.success is True
                ...
                "content": [
                    {
                        ...
                        "data": {
                            "content": [
                                ...
                                {"type": "image", "data": {"file": temp_test_files["image"]}}
                            ]
                        }
                    }
                ]
